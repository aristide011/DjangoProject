...
urlpatterns =[
    ...
    path('playlist/create',PlaylistCreateView.as_view(),name='playlist_form'),
    path('playlist/delete/<int:pk>/',PlaylistDeleteView.as_view(),name='playlist_confirm_delete'),
    path('playlist/update/<int:pk>/',PlaylistUpdateView.as_view(),name='playlist_form'),
    path('recommendations/',RecommendationsListView.as_view() ,name='recommendation_list'),
    path('recommendations/create',RecommendationsCreateView.as_view(), name='recommendation_form'),
